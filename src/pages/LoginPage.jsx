...
const LoginPage = () => {
  ...
  useEffect(() => {
    const fetchMasterData = async () => {
      ...
      try {
        ...
        const SPREADSHEET_ID = "1sn8_JWWODv3JM097Q1oIpVt0EhxRxEBi4sy7onV95tc"
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 p-4">
      <div className="w-full max-w-md shadow-2xl border border-slate-200 rounded-xl bg-white overflow-hidden">
        <div className="space-y-1 p-6 bg-slate-50 border-b border-slate-200">
          <div className="flex items-center justify-center mb-2">
            <i className="fas fa-clipboard-list h-8 w-8 text-blue-600 mr-2"></i>
            <h2 className="text-2xl font-bold text-slate-800">Checklist & Delegation</h2>
          </div>
          <p className="text-center text-slate-600">Login to access your tasks and delegations</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div className="p-6 bg-slate-50 border-t border-slate-100">
            <button
              type="submit"
              className="w-full py-2.5 px-4 bg-blue-600 hover:bg-blue-700 text-white rounded-md font-bold shadow-md transition-all duration-200 disabled:opacity-50"
        ...
        <div className="fixed left-0 right-0 bottom-0 py-2 px-4 bg-slate-800 text-white text-center text-sm shadow-2xl z-10">
          <a
          ...
          >
            Powered by - <span className="font-bold tracking-wide">Botivate</span>
          </a>
        </div>
      </div>
