          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-blue-600 to-blue-700 bg-clip-text text-transparent">
                {showHistory ? "Service History" : "Service Operations"}
              </h1>
              <p className="text-sm text-slate-600 mt-1">
                {showHistory ? "Access archived service records and maintenance logs" : "Monitor and process active service requests"}
              </p>
            </div>
          </div>
        ...
        <div className="rounded-2xl border border-slate-200 shadow-lg bg-white overflow-hidden">
          <div className="bg-gradient-to-r from-slate-50 to-slate-100 p-4 border-b border-slate-200 flex flex-wrap items-center gap-4">
            ...
            <div className="flex-1 min-w-[200px] relative">
              ...
              <input
                type="text"
                placeholder={showHistory ? "Search service history..." : "Search operations queue..."}
                value={searchTerm}
          ...
          {showHistory && membersList.length > 0 && (
            <div className="p-4 bg-white border-b border-slate-100">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Service Personnel</span>
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-slate-800 leading-none">
                  {showHistory ? "Archive Registry" : "Current Service Orders"}
                </h2>
                <p className="text-xs text-slate-500 mt-1">
                  {showHistory 
                    ? `Historical registry of all completed service tasks` 
                    : `Managing ${filteredAccountData.length} active service items`}
                </p>
              </div>
            </div>
          </div>
