    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full animate-in zoom-in-95 duration-300 border border-slate-100">
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-2xl font-bold text-slate-800 mb-2">Director's Confirmation</h2>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-blue-600 to-blue-700 bg-clip-text text-transparent">
                {showHistory ? "Directorate Records" : "Director Workspace"}
              </h1>
              <p className="text-sm text-slate-600 mt-1">
                {showHistory ? "Review and manage archived high-level operations" : "Executive task tracking and operational oversight"}
              </p>
            </div>
          </div>
        ...
        <div className="rounded-2xl border border-slate-200 shadow-lg bg-white overflow-hidden">
          <div className="bg-gradient-to-r from-slate-50 to-slate-100 p-4 border-b border-slate-200 flex flex-wrap items-center gap-4">
            ...
            <div className="flex-1 min-w-[200px] relative">
              ...
              <input
                type="text"
                placeholder={showHistory ? "Search archive..." : "Search active items..."}
                value={searchTerm}
          ...
          {showHistory && membersList.length > 0 && (
            <div className="p-4 bg-white border-b border-slate-100">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Executive Team</span>
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-slate-800 leading-none">
                  {showHistory ? "Historical Decision Log" : "Pending Director Approvals"}
                </h2>
                <p className="text-xs text-slate-500 mt-1">
                  {showHistory 
                    ? `Archived records for executive review` 
                    : `Active tracking for ${filteredAccountData.length} critical items`}
                </p>
              </div>
            </div>
          </div>
