...
const CONFIG = {
  ...
  SHEET_NAME: "REFRATECH",

  // Page configuration
  PAGE_CONFIG: {
    title: "REFRATECH Tasks",
    historyTitle: "REFRATECH Task History",
          ...
          {showHistory && getFilteredMembersList().length > 0 && (
            <div className="p-4 bg-white border-b border-slate-100">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Team Filtering</span>
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-1">
                  {showHistory 
                    ? `Reviewing archived records for ${CONFIG.SHEET_NAME}` 
...
export default RefratechDataPage
