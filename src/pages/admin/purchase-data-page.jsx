          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-blue-600 to-blue-700 bg-clip-text text-transparent">
                {showHistory ? "Purchase History" : "Purchase Workspace"}
              </h1>
              <p className="text-sm text-slate-600 mt-1">
                {showHistory ? "Review and manage archived procurement records" : "Real-time procurement tracking and task management"}
              </p>
            </div>
          </div>
          ...
          {showHistory && membersList.length > 0 && (
            <div className="p-4 bg-white border-b border-slate-100">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Procurement Teams</span>
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-slate-800 leading-none">
                  {showHistory ? "Historical Decision Log" : "Pending Purchase Approvals"}
                </h2>
                <p className="text-xs text-slate-500 mt-1">
                  {showHistory 
                    ? `Archived records for procurement review` 
                    : `Active tracking for ${filteredAccountData.length} items`}
                </p>
              </div>
            </div>
          </div>
