...
export default function AdminDashboard() {
  ...
  const fetchMasterSheetColumnA = async () => {
    try {
      ...
      const response = await fetch(`https://docs.google.com/spreadsheets/d/1hlFNmLJ_qY7LMpN0pP-N3KWdf0_JRwFvfqWjjLyCDb8/gviz/tq?tqx=out:json&sheet=MASTER`)
  ...
  const fetchDepartmentData = async (department) => {
    ...
    try {
      ...
      const response = await fetch(`https://docs.google.com/spreadsheets/d/1hlFNmLJ_qY7LMpN0pP-N3KWdf0_JRwFvfqWjjLyCDb8/gviz/tq?tqx=out:json&sheet=${sheetName}`);
