...
/>
        ...
        <Route path ="/admin/LearningVideo" element={<Navigate to="/dashboard/LearningVideo" replace />} />
        <Route path ="/admin/Liecence" element={<Navigate to="/dashboard/Liecence" replace />} />
